  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="project-image p-6 bg-gradient-to-r from-primary-400/80 to-primary-600/90">
        <Image
          src="/images/projects/Kettlebell_Gear_MERN_Stack.png"
          alt="Website image"
          width={650}
          height={650}
      ...
      <div className="project-info container mx-auto px-6 md:px-24 text-[#565b5f] dark:text-white">
        ...
        <section className="flex flex-col md:flex-row justify-between my-10">
          <div className="flex flex-col mb-4">
            ...
            <div className="feature-one space-y-1 mb-6">
              ...
              <li>
                Enable administrators to manage products through functions like
                addition, modification, and removal for efficient content
                editing
              </li>
            </div>
            <div className="feature-one space-y-1 mb-6">
              ...
              <li>
                ...
                while implementing pagination to efficiently manage and navigate
                through the vast array of products
              </li>
            </div>
            <div className="feature-one space-y-1 mb-6">
              <p className="font-semibold">
              ...
              <li>
                Employs JWT authorization with HttpOnly Cookie, ensuring secure
                access and management of products, users, and orders, thereby
        ...
        <section className="flex flex-col md:flex-row justify-between my-10">
          <div className="flex flex-col mb-4">
            <h2 className="font-semibold mb-3">Full shopping cart features</h2>
