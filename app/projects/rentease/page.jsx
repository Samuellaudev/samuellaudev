          ...
          <div className="flex flex-col mb-4">
            ...
            <div className="feature-one space-y-1 mb-6">
              ...
              <li>
                ...
                streamlined data management, and integrate search functionality
                to help users find properties based on various criteria,
                ensuring a user-friendly experience for both administrators and
                visitors
              </li>
            </div>
            <div className="feature-one space-y-1 mb-6">
              ...
              <li>
                Enable users to sign in with their Google accounts, streamlining
